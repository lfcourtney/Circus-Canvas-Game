...
function loadSprites() {
    ...
    //Player Sprites
    idleStance.onload = loadAssets;
    //Player Walk
    walkOne.onload = loadAssets;
    walkTwo.onload = loadAssets;
    //Player Fall
    flyOne.onload = loadAssets;
    flyTwo.onload = loadAssets;
    flyThree.onload = loadAssets;
    flyFour.onload = loadAssets;
    flyFive.onload = loadAssets;
    //Player Fail
    failOne.onload = loadAssets;
    failTwo.onload = loadAssets;
    failThree.onload = loadAssets;
}
